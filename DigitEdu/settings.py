"""
Django settings for DigitEdu project.
...
SECRET_KEY = 'npu*=fy#$zaq46_%m!n@9lfl^$k8hygytx=9%h$wsot=_cvt--'
...
WSGI_APPLICATION = 'DigitEdu.wsgi.application'
